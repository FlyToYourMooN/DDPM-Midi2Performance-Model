...
def get_pianoroll_and_mel(config, wav_path):
    ...
    wav = torchaudio.functional.resample(wav[0], sr, config.sample_rate.sample_rate).unsqueeze(0)
    ...
    #get pianoroll
    pianoroll = midi.get_piano_roll(fs=config.sample_rate.sample_rate//config.data.hop_length)
    #align length
